...
public class UserInfoIn {
    ...
    public static String getUserId(HttpServletRequest request){
        ...
        if (principal instanceof KeycloakPrincipal) {
            ...
            System.out.println("--------------- Key cloack .------------------");
            System.out.println(kp.getKeycloakSecurityContext().getTokenString());
            System.out.println("--------------- Key cloack realm .------------------");
            System.out.println(kp.getKeycloakSecurityContext().getRealm());
