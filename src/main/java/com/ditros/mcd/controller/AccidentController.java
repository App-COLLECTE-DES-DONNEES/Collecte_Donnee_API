...
public class AccidentController {
 ...
 public ResponseEntity<Object> modifyAccident(
            @RequestPart(name = "accidentReq") String accidentReq 
    ){
        try{
            System.out.println("Modify ACCIDENT REQUEST");
            Gson gson = new Gson();
            AccidentReq req = gson.fromJson(accidentReq,AccidentReq.class);
            
            return ApiResponseHandler.generateResponse(HttpStatus.OK,
                    true, "accident successfully modified",
                    accidentService.modifyAccident(req, UserInfoIn.getUserId(request)) );
        }catch(Exception e){
            e.printStackTrace();
...
//     public ResponseEntity<Object> exportAccidenttopdf(
...
//                 accidentService.expotAccidenttopdf(id, UserInfoIn.getUserId(request)) );
//     }catch(Exception e){
//         e.printStackTrace();
//         return ApiResponseHandler.generateResponse(HttpStatus.OK,false, "Error while declaring accident :"+e.getMessage(), null );
...
@PostMapping(consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public ResponseEntity<Object> declareAccident(
        ...
        try{
            System.out.println("DECLARE ACCIDENT REQUEST");
            Gson gson = new Gson();
            AccidentReq req = gson.fromJson(accidentReq,AccidentReq.class);
    ...
    /*
     accidentstatsbar is used to have the diffrent informations about the bar diagram of the accident i a certain period
     */
@PostMapping(value="/accidentstatsbar",consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public ResponseEntity<Object> getstataccident(
            @RequestPart(name = "year") String year,
            @RequestPart(name="month") List<String> month
    ){
        try{
            System.out.println("GET STATISTIC OF ACCIDENT REQUEST");
            
            return ApiResponseHandler.generateResponse(HttpStatus.OK,
                    true, "accident successfully declared",
                    accidentService.accidentstatistics(UserInfoIn.getUserId(request),year,month));
        }catch(Exception e){
            e.printStackTrace();
            return ApiResponseHandler.generateResponse(HttpStatus.OK,false, "Error while declaring accident :"+e.getMessage(), null );
    ...
    @PostMapping(value="/accidentstatscircle",consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public ResponseEntity<Object> getstataccidents(
            @RequestPart(name = "year") String year,@RequestPart(name = "month") String month  
    ){
        try{
            System.out.println("GET STATISTIC OF ACCIDENT REQUEST");
            ...
            return ApiResponseHandler.generateResponse(HttpStatus.OK,
                    true, "accident successfully declared",
                    accidentService.accidentstatistics1(UserInfoIn.getUserId(request),year,month));
        }catch(Exception e){
            e.printStackTrace();
            return ApiResponseHandler.generateResponse(HttpStatus.OK,false, "Error while declaring accident :"+e.getMessage(), null );
...
@PostMapping(value="/notification", consumes =MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Object> savenotificatipnaccident(
            @RequestBody NotificationaccidentResp notification 
    ){
        try{
            System.out.println("Save Notification OF ACCIDENT REQUEST");
            System.out.println(notification);
            return ApiResponseHandler.generateResponse(HttpStatus.OK,
                    true, "accident successfully declared",
                    accidentService.SaveNotification(notification));
        }catch(Exception e){
            e.printStackTrace();
            return ApiResponseHandler.generateResponse(HttpStatus.OK,false, "Error while saving notification :"+e.getMessage(), null );
    ...
    @PostMapping(value = "/import-drawing",consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public ResponseEntity<Object> importDraw(
            @RequestPart(name = "image") MultipartFile vehicule,
            @RequestPart(name = "accident_id") String id
    ){
        try{
            ...
            return ApiResponseHandler.generateResponse(HttpStatus.OK,
                    true, "vehicle image successfully saved",
                    accidentService.importDrawing(vehicule, id) );
        }catch(Exception e){
            e.printStackTrace();
            return ApiResponseHandler.generateResponse(HttpStatus.OK,false, "Error while declaring accident :"+e.getMessage(), null );
   ...
   @GetMapping(value = "/notif",consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public ResponseEntity<Object> getnotification(
        ...
        try{
            ...
            return ApiResponseHandler.generateResponse(HttpStatus.OK,
                    true, "crash image successfully saved",
                    accidentService.getNotification(UserInfoIn.getUserId(request),page) );
        }catch(Exception e){
            e.printStackTrace();
            return ApiResponseHandler.generateResponse(HttpStatus.OK,false, "Error while declaring accident :"+e.getMessage(), null );
...
@GetMapping(value="/notification")
    public ResponseEntity<Object> Getnotificatipnaccident(
           @RequestParam(name = "page", defaultValue = "0") int page,
                                                  @RequestParam(name = "size", defaultValue = "10") int size,
                                                  @RequestParam(name = "search", defaultValue = "") String search
    ){
        try{
            System.out.println("get Notification OF ACCIDENT REQUEST");
            
            return ApiResponseHandler.generateResponse(HttpStatus.OK,
                    true, "accident successfully declared",
                    accidentService.getAllnotifications(UserInfoIn.getUserId(request),page,size, search));
        }catch(Exception e){
            e.printStackTrace();
            return ApiResponseHandler.generateResponse(HttpStatus.OK,false, "Error while saving notification :"+e.getMessage(), null );
