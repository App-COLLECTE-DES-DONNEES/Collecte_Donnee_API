...
public class CareController {
    ...
    @PostMapping
    public ResponseEntity<Object> declareCare(@RequestBody CareReq careReq){
        try{
    ...
    @PostMapping(value="modify-cares")
    public ResponseEntity<Object> modifyCare(@RequestBody CareReq careReq){
        try{
            CareResp careResp = careService.modifyCare(
                careReq, UserInfoIn.getUserId(request));
            return ApiResponseHandler.generateResponse(HttpStatus.OK, true, "Care successfully declared", careResp);
        }catch (Exception e){
            e.printStackTrace();
    ...
    public ResponseEntity<Object> getCareList(
        ...
        try{
            ...
            //String userId = "47ef1b23-ed0d-47b4-9d5d-9fb42e6f05fe";
